...
install_applications() {
    ...
    flatpak install flathub io.github.zen_browser.zen    # Browser
    flatpak install flathub io.github.flattool.Warehouse # Flatpak package manager
    ...
    line_break
    ask_user_to_execute_command "Do you want to install Warp Terminal?" install_warp "Skipping Warp." # Warp - AI Terminal
    line_break
    ask_user_to_execute_command "Do you want to install Github Desktop?" "flatpak install flathub io.github.shiftey.Desktop" "Skipping Github Desktop." # Github Desktop
    line_break
    ask_user_to_execute_command "Do you want to install OBS Studio?" "flatpak install flathub com.obsproject.Studio" "Skipping OBS Studio." # OBS Studio
    line_break
    ask_user_to_execute_command "Do you want to install Blender?" "flatpak install flathub org.blender.Blender" "Skipping Blender." # Blender
    line_break
}
...
manual_setup() {
    printf "
1. Install following GNOME extensions: User Themes, Blur my Shell, GS Connect, Compiz alike window effect, Gnome Clipboard\n
